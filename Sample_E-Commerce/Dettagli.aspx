<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Dettagli.aspx.cs" Inherits="Sample_E_Commerce.Dettagli" %>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-8">
                        <div class="card-body mt-5">
                            ...
                            <asp:Button ID="GoCart" runat="server" Text="Vai al Carrello" OnClick="Carrello_Click" CssClass="border border-0 bg-opacity-10"/>
                        </div>
                    </div>
                </div>
            </div>
